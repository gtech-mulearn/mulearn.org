...
const Stepsyip = () => {
  return (
    <div class={classes.thirdSection} id="timeline">
      <p class={classes.tsheading}>YIP Idea Registration Procedure</p>
      <div class={classes.timeline__container}>
        <div class={classes.timeline}>
          <div class="timeline__event animated fadeInUp delay-3s timeline__event--type1">
            <div class="timeline__event__icon">
              <img src="assets/procedure/prereg.png" alt="" class="lni-cake" />
            </div>
            ...
            <div class="timeline__event__content">
              ...
              <div class="timeline__event__description">
                <p>
                  ...
                  to go to the Pre-Registration page. Enter all your details in
                  the Pre-Registration Form and Complete the OTP Verification.
                  By Now you would have recived an email with login credentials,
                  you can now login with that.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="timeline__event animated fadeInUp delay-1s timeline__event--type3">
            <div class="timeline__event__icon">
              <img src="assets/procedure/yip-voc.png" alt="" class="lni-cake" />
            </div>
            <div class="timeline__event__date">
              Voice of <br />
              Customer
            ...
            <div class="timeline__event__content">
              ...
              <div class="timeline__event__description">
                <p>
                  After completing your Profile and submitting it, You can check
                  the left navbar again to find the
                  <b>Voice of Customer(VOC)</b> option. By clicking that you
                  will be directed to the course page where you can complete it.
                </p>
              </div>
            </div>
          </div>
          <div class="timeline__event animated fadeInUp timeline__event--type1">
            ...
            <div class="timeline__event__content">
              ...
              <div class="timeline__event__description">
                <p>
                  After completing the VOC Course and attending the quiz there.
                  <b>
                  ...
                  while the other members can join it using the team's name and
                  password.
                </p>
              </div>
            </div>
          ...
          <div class="timeline__event animated fadeInUp delay-3s timeline__event--type1">
            ...
            <div class="timeline__event__content">
              ...
              <div class="timeline__event__description">
                <p>
                  After forming a team and finding an idea which suits the given
                  themes, the <b>person who formed the team</b> can submit the
                  idea by going to the
          ...
          <div class="timeline__event animated fadeInUp delay-2s timeline__event--type2">
            ...
            <div class="timeline__event__content">
              ...
              <div class="timeline__event__description">
                <p>
                  After the submission of the idea, it requires the approval of
                  the repective Institution and you may contact the concerned
                  authority for the approval of your idea.
                </p>
              </div>
            </div>
          </div>
